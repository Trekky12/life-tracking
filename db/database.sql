...
CREATE TABLE IF NOT EXISTS global_banlist (
    id INTEGER unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS finances_paymethods (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    user INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS finances_recurring (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    user INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS finances_categories_assignment (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    user INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS finances_budgets_categories (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS finances_transactions_recurring (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    user INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS cars_service (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    ...
    refill_price DECIMAL(6,2) DEFAULT NULL,
    refill_amount DECIMAL(6,2) DEFAULT NULL,
    refill_total_price DECIMAL(6,2) DEFAULT NULL,
    refill_full INT(1) DEFAULT 0,
    refill_distance INT(20) DEFAULT NULL,
    calc_refill_consumption int(1) DEFAULT 1,
    refill_consumption DECIMAL(6,2) DEFAULT NULL,
    refill_location varchar(255) DEFAULT NULL,
    notice TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS boards_user (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS boards_stacks (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    board INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    createdBy INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS boards_cards_user (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS boards_cards_label (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    card INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS global_widgets (
  id int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  user INTEGER unsigned DEFAULT NULL,
  createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS crawlers_user (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS crawlers_headers (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    crawler INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS crawlers_dataset (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    crawler INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS crawlers_links (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    crawler INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS splitbill_groups (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    user INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS splitbill_groups_user (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS splitbill_bill (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    sbgroup INTEGER unsigned DEFAULT NULL,
    user INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS splitbill_bill_users (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS splitbill_bill_recurring (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    sbgroup INTEGER unsigned DEFAULT NULL,
    user INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS splitbill_bill_recurring_users (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    bill INTEGER unsigned DEFAULT NULL,
    user INTEGER unsigned DEFAULT NULL,
    paid DECIMAL(10,2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS trips_user (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS trips_event (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    trip INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS trips_route (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    trip INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS global_users_mobile_favorites (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    user INTEGER unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS global_users_application_passwords (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    user INTEGER unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS timesheets_projects (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    user INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    ...
    show_week_button INT(1) DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS timesheets_projects_users (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS timesheets_customers (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    project INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS timesheets_sheets (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    project INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS timesheets_categories (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    project INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS timesheets_sheets_categories (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS timesheets_categorybudgets (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    project INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    ...
    counter ENUM('past','happened', 'all') default 'happened',
    PRIMARY KEY (id),
    FOREIGN KEY(project) REFERENCES timesheets_projects(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY(user) REFERENCES global_users(id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS timesheets_categorybudgets_categories (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS timesheets_sheets_notices (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    createdBy INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS timesheets_noticefields (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    project INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS workouts_bodyparts (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    createdBy INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS workouts_muscles (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    createdBy INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS workouts_exercises_muscles (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS workouts_plans_exercises (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS workouts_sessions (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    user INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS workouts_sessions_exercises (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS recipes_cookbooks_users (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS recipes_groceries (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
    createdBy INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS recipes_cookbook_recipes (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    createdBy INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS recipes_mealplans (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    user INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS recipes_mealplans_users (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS recipes_mealplans_recipes (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    createdBy INTEGER unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS recipes_shoppinglists (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    user INTEGER unsigned DEFAULT NULL,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    changedOn TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS recipes_shoppinglists_users (
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS recipes_shoppinglists_entries (
    id int(11) unsigned NOT NULL AUTO_INCREMENT,
    createdOn TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    createdBy INTEGER unsigned DEFAULT NULL,
