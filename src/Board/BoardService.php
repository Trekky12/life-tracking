...
use App\Board\Stack\Mapper as StackMapper;
use App\Board\Card\Mapper as CardMapper;
use App\Board\Label\Mapper as LabelMapper;

class BoardService extends \App\Base\Service {
