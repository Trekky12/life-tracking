...
class CrawlerDatasetService extends \App\Domain\Service {
    ...
    public function getDataFromCrawler($crawler_id, $from, $to, $filter, $sortColumn, $sortDirection, $count) {
        return $this->mapper->getDataFromCrawler($crawler_id, $from, $to, $filter, $sortColumn, $sortDirection, 20);
    }
