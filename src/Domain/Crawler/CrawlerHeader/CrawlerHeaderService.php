...
class CrawlerHeaderService extends \App\Domain\Service {

    protected $dataobject = \App\Domain\Crawler\CrawlerHeader\CrawlerHeader::class;
    ...
    public function cloneHeaders(\App\Domain\Crawler\Crawler $target, \App\Crawler\Crawler $destination) {
