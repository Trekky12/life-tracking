...
class Customer extends \App\Domain\DataObject {
    ...
    public function parseData(array $data) {
        ...
        if ((!empty($this->background_color) && !is_null($this->background_color) && !preg_match("/^#[a-f0-9]{6}$/i", $this->background_color)) || (!empty($this->text_color) && !is_null($this->text_color) && !preg_match("/^#[a-f0-9]{6}$/i", $this->text_color))) {
