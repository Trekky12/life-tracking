...
class CustomerRemover extends ObjectActivityRemover {

    private $service;
    private $project_service;
    private $project_mapper;

    public function __construct(LoggerInterface $logger, CurrentUser $user, ActivityCreator $activity, CustomerService $service, CustomerMapper $mapper, ProjectService $project_service, ProjectMapper $project_mapper) {
    ...
    public function getObjectViewRoute(): string {
        return 'timesheets_customers_edit';
    }
