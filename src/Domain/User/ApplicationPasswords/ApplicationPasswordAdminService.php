...
class ApplicationPasswordAdminService extends Service {

    private $user_service;

    public function __construct(LoggerInterface $logger, CurrentUser $user, ApplicationPasswordMapper $mapper, UserService $user_service) {
    ...
    public function index($user_id) {
        ...
        $favorites = $this->mapper->getAll('name');
    ...
    public function edit($user_id, $entry_id) {
        ...
        return new Payload(Payload::$RESULT_HTML, ['entry' => $entry, 'for_user' => $user, 'password' => $password]);
    }
