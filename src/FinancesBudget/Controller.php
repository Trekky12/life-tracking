...
class Controller extends \App\Base\Controller {
    ...
    public function init() {
        ...
        $this->monthly_mapper = new \App\FinancesMonthly\Mapper($this->ci);
    }
    ...
    public function index(Request $request, Response $response) {
        ...
        $budgets = $this->mapper->getBudgets();
        ...
        return $this->ci->view->render($response, 'finances/budgets/index.twig', [
                    'budgets' => $budgets,
    ...
    public function edit(Request $request, Response $response) {
        ...
        return $this->ci->view->render($response, 'finances/budgets/edit.twig', [
                    'budgets' => $budgets,
                    'categories' => $categories,
                    'income' => $income,
                    'monthly' => $monthly,
