...
class Controller extends \App\Base\Controller {
    ...
    public function editSteps(Request $request, Response $response) {
        ...
        return $this->ci->view->render($response, 'location/steps/edit.twig', ['date' => $date, 'steps' => $steps > 0 ? $steps : 0]);
    }
    ...
    public function saveSteps(Request $request, Response $response) {
        ...
        $redirect_url = $this->ci->get('router')->pathFor('steps_stats_month', ['year' => $dateObj->format('Y'), 'month' => $dateObj->format('m')]);
