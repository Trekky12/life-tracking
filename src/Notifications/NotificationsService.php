...
class NotificationsService extends \App\Base\Service {
    ...
    public function sendNotification(\App\Notifications\Clients\NotificationClient $entry, $title, $content, $path = null, $id = null) {
