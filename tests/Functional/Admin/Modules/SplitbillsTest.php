...
class SplitbillsTest extends BaseTestCase {

    protected function setUp(): void {
        $this->login("user_module_splitbills", "user_module_splitbills");
    }
    ...
    public function testModuleSplitbills() {
        ...
        $this->assertEquals("/splitbills/groups/", $response->getHeaderLine("Location"));
    }
