...
class TimesheetsTest extends BaseTestCase {

    protected function setUp(): void {
        $this->login("user_module_timesheets", "user_module_timesheets");
    }
    ...
    public function testModuleTimesheets() {
        ...
        $this->assertEquals("/timesheets/projects/", $response->getHeaderLine("Location"));
    }
