...
class OtherUserTest extends BaseTestCase {
    ...
    public function testPostElementCreatedSave($csrf) {
        ...
        $response = $this->request('POST', $this->uri_save . $this->TEST_FINANCE_RECURRING_ID, array_merge($data, $csrf));
    ...
    public function testDeleteElement() {
        ...
        $response = $this->request('DELETE', $this->uri_delete . $this->TEST_FINANCE_RECURRING_ID, $csrf);
