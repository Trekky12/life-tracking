...
class OtherUserUpdatePaymethod extends SplitbillTestBase {
    ...
    public function testGetChildEdit() {
        ...
        $this->assertStringContainsString("<form class=\"form-horizontal\" id=\"splitbillsBillsForm\" action=\"" . $this->getURIRecurringSave($this->TEST_GROUP_HASH) . $this->TEST_BILL_ID . "\" method=\"POST\">", $body);
    }
