...
class OwnerTest extends TimesheetTestBase {
    ...
    public function testList() {
        ...
        $this->assertStringContainsString('<table id="requirement_types_table"', $body);
    }
    ...
    public function testAddedElement($data) {
        ...
        $body = (string) $response->getBody();
        $row = $this->getRequirementElementInTable($body, $data, $this->TEST_PROJECT_HASH);
    ...
    public function testGetElementUpdated(array $result_data) {
        ...
        $row = $this->getRequirementElementInTable($body, $result_data, $this->TEST_PROJECT_HASH);
